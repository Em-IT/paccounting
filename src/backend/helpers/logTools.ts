...
export const logApi = (text: string, ...otherArgs: any) => {
  ...
  console.log(
    colors.bg.blue, colors.fg.white, colors.bold, 'API Call', colors.bg.end, colors.boldEnd,
...
export const logError = (text: string, ...otherArgs: any) => {
  ...
  console.log(
    colors.bg.red, colors.fg.white, colors.bold, 'Error', colors.bg.end, colors.boldEnd,
